  ...
  return (
   ...
   <a key={index} href={data.Link} className={
      ...
      {data.text} 
               ...
               <p className='text-[#bdbdbd] '> © {currentYear} Gajendra Naphade | All Rights Reserved | Developed by <a href='https://linkedin.com/in/gajendra-naphade' target='_blank' className='text-white hover:underline underline-offset-2 font-medium'>Gajendra Naphade </a></p>
