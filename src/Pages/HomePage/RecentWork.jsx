...
const RecentWork = memo(()=>{
  ...
  // Function to filter work data based on selected category
  ...
  return (
    <div className='font-sora flex flex-col items-center md:px-3 !py-0 !pb-24 lg:px-10 xl:p-28 w-full gap-14'>
      ...
      <div className='flex flex-col px-4 md:px-0 md:flex-row transition-all duration-500 md:flex-wrap relative justify-between w-full py-4'>
        ...
        {paginatedData.map((work, index) => (
          ...
          key={index} className='relative md:w-[48%] p-5 group md:p-10 pb-0 rounded-[10px] overflow-hidden workDiv mb-[30px] xl:mb-[50px] shadow-xl max-h-[276px] md:max-h-[336px] lg:max-h-[436px] xl:max-h-[506px]'>
            ...
            <div className='Service-Btn  rounded-xl flex justify-between items-center p-6'>
              ...
              <a href="" className='-rotate-[220deg]'> <Arrow className='w-7 h-7 ' /> </a>
            </div>
